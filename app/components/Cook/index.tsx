            ...
            <div className="mx-auto max-w-7xl lg:pt-20 sm:pb-24 px-6">
                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 my-16 space-x-5'>
                    ...
                    <div className='col-span-6 flex flex-col justify-center'>
                        ...
                        <p className='text-grey md:text-lg font-normal mb-10 text-start mt-1'>Nous comprenons l&apos;importance de la rapidité dans le monde des affaires et nous nous engageons à vous offrir la meilleure expérience de livraison.</p>
                        <p className='text-grey md:text-lg font-normal mb-10 text-start mt-1'>Naviguez facilement à travers notre interface conviviale et intuitive.Que vous soyez un nouveau commerçant ou un habitué de la vente en ligne, notre plateforme est conçue pour être facile à utiliser, vous permettant ainsi de gérer vos commandes et votre inventaire en toute simplicité.
